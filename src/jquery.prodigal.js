;(function($, window, document, undefined){
    ...
    open: function(e){
      ...
      if(options.isActive == false){
        ...
        $(document).find('.prodigal-thumbs').each(function(i, obj){
          ...
          image = $('\
            <div class="image_item"><a class="prodigal_thumb" href="'+media_url + '"><img src="'+thumbnail+'"/></a></div> \
          ');
          ...
          options._wrapper.find('.prodigal_gallery_right').append(
  ...
  imageClickHandler = function(e){
    ...
    // TODO detect the url type, if video then use video helper#
  ...
  sorterChangeHandler = function(){
	  switch($(this).find(':selected').val()){
	  	...
	  	case "images":
	  		...
	  		//options._wrapper.find('.image_item[data-prodigal-media-type=image]').css({ display: 'block' });
	  		//options._wrapper.find('.image_item[data-prodigal-media-type!=image]').css({ display: 'none' });
	  		break;
	  	case "videos":
	  		options._wrapper.find('.image_item').each(function(){
	  		...
	  		//options._wrapper.find('.image_item[data-prodigal-media-type=video]').css({ display: 'block' });
	  		//options._wrapper.find('.image_item[data-prodigal-media-type!=video]').css({ display: 'none' });
	  		break;
	  }
  },
